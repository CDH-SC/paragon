...
int book_pipeline_single (char img1_file[512], char img2_file[512], Mat &img_template_new, Mat &img_target_new, vector<Point> &feat_template_f, vector<Point> &feat_target_f)
{
    cout << img1_file << endl;
    cout << img2_file << endl;
...
/***************************************************************/
   ...
   // }
    ...
    cout << "feature point extraction complete..." << endl;
