...
module1 = Extension('patchsingmod',
		  ...
		  sources=['patchsingmodule.cpp','patch_match.cpp','compute_jaccard.cpp','find_diff.cpp','refine_match.cpp','tps.cpp','book_pipeline_single.cpp','imgfeatures.c','kdtree.c','minpq.c','sift.c','utils.c'],
	          language='c++',
                  extra_compile_args=['-O3'])
		  
setup(name='patchsingmod',
      version='1.0',
	  description='blah',
	  author='blah',
	  url='blah',
