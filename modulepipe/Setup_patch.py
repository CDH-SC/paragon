...
module1 = Extension('patchmod',
		  ...
		  sources=['patchmodule.cpp','patch_match.cpp','compute_jaccard.cpp','find_diff.cpp','refine_match.cpp','tps.cpp','book_pipeline.cpp','imgfeatures.c','kdtree.c','minpq.c','sift.c','utils.c'],
	          language='c++',
